 ...
 */
final class Version20231010080052 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE videos (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, duration INT DEFAULT NULL, like_count INT DEFAULT 0 NOT NULL, dislike_count INT DEFAULT 0 NOT NULL, filename VARCHAR(255) DEFAULT NULL, origin_filename VARCHAR(255) DEFAULT NULL, updated_at DATETIME NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_29AA643212469DE2 (category_id), INDEX filename_idx (filename), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
