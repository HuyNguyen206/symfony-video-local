 ...
 */
final class Version20231006063738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_interactive_video ADD CONSTRAINT FK_E5B9DB28A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
